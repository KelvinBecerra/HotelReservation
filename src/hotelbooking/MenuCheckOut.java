...
public class MenuCheckOut extends javax.swing.JFrame {
     ...
     */
    public MenuCheckOut(HashClientes h, ArbolReserva ar, ArregloHabitaciones ah) {
        initComponents();
        this.clientes = h;
        this.reservas = ar;
        this.habs = ah;
        this.funciones = new Funciones_Hotel(ar, h, ah);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCheckOut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCheckOut(clientes, reservas, habs).setVisible(true);
            }
        });
    }
