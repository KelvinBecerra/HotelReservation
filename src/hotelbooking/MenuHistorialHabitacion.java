...
public class MenuHistorialHabitacion extends javax.swing.JFrame {
     ...
     */
    public MenuHistorialHabitacion(HashClientes h, ArbolReserva ar, ArregloHabitaciones ah) {
        initComponents();
        this.clientes = h;
        this.reservas = ar;
        this.habs = ah;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MENÚ DE HISTORIAL");
        ...
        jLabel3.setText("Introduzca el nro de habitación para ver su historial:");
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 200, 80, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuHistorialHabitacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuHistorialHabitacion(clientes, reservas, habs).setVisible(true);
            }
        });
    }
