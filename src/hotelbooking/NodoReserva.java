...
public class NodoReserva {
    ...
    private NodoReserva HijoIzquierdo;
    private NodoReserva HijoDerecho;
    private int altura;

    public NodoReserva(int ci, String primer_nombre, String segundo_nombre, String email, String genero, String tipo_hab, String celular, String fecha_llegada, String fecha_salida) {
        this.ci = ci;
    ...
    public String toString(){
        return "Nombre: " + this.primer_nombre + " " + this.segundo_nombre + "\nCorreo: " + this.email + "\nGenero: " + this.genero + "\nCelular: " + this.celular + "\nLlegada: " +
     ...
     */
    public NodoReserva getHijoIzquierdo() {
     ...
     */
    public void setHijoIzquierdo(NodoReserva HijoIzquierdo) {
     ...
     */
    public NodoReserva getHijoDerecho() {
        return HijoDerecho;
    }
     ...
     */
    public void setHijoDerecho(NodoReserva HijoDerecho) {
